...
divElem.innerHTML = '63 Years Old';
...
var newThurst = document.createElement('div');
newThurst.id = 'wants';
newThurst.innerHTML = 'Looking for Mrs. McDonald';
data.appendChild(newThurst);
...
newPro2.id = 'pro2';
newPro2.innerHTML = "Enjoys flipping burgers and eating. It's his passion!";
data.appendChild(newPro2);
